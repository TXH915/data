const projects = [
    {
        ...
        theory: `
<h3>一、数据清洗概述</h3>
<p>数据清洗是数据分析流程的第一步，也是最关键的一步。据统计，数据分析师约80%的时间都花在数据清洗上。</p>

<h4>1.1 数据质量的重要性</h4>
<ul>
    <li><b>"垃圾进，垃圾出"</b>：错误的数据会导致错误的分析结果</li>
    <li><b>决策影响</b>：错误的数据可能导致错误的商业决策</li>
    <li><b>模型训练</b>：脏数据会降低机器学习模型的准确性</li>
</ul>
...
<p>数据集中某些字段为空或不存在</p>
<ul>
    <li><b>原因</b>：数据采集遗漏、用户拒绝填写、系统错误</li>
...
<p>与其他数据显著不同的数值</p>
<ul>
    <li><b>原因</b>：数据录入错误、测量误差、真实异常事件</li>
...
<h4>4.2 Z-score方法</h4>
<ul>
    <li><b>步骤</b>：计算每个数据点的Z分数</li>
    <li><b>异常值定义</b>：|Z| > 3（通常阈值）</li>
    <li><b>优点</b>：适用于正态分布数据</li>
    <li><b>缺点</b>：受极端值影响较大</li>
</ul>

<h4>4.3 可视化方法</h4>
<ul>
    <li><b>箱线图</b>：直观展示数据分布和异常值</li>
    <li><b>散点图</b>：发现离群点</li>
    <li><b>直方图</b>：观察数据分布形态</li>
</ul>

<h4>4.4 异常值处理策略</h4>
<ul>
    <li><b>删除</b>：确认是错误数据时</li>
...
<h3>六、数据清洗工作流程</h3>
<ol>
    <li><b>检查数据</b>：查看数据结构、统计摘要</li>
    <li><b>识别问题</b>：找出缺失值、异常值、重复数据</li>
    <li><b>制定策略</b>：根据问题类型选择处理方法</li>
    <li><b>执行清洗</b>：应用清洗操作</li>
    <li><b>验证结果</b>：检查清洗后的数据质量</li>
    <li><b>记录日志</b>：保存清洗过程和决策</li>
        ...
        exam: {
            singleChoice: [
                {
                    question: "数据清洗通常占数据分析工作的比例约为？",
                    options: ["20%", "50%", "80%", "95%"],
                    answer: 2
                },
                {
                    question: "以下哪种方法最适合填充偏态分布数据的缺失值？",
                    options: ["均值", "中位数", "众数", "0"],
                    answer: 1
                },
                {
                    question: "Z-score方法适用于哪种数据分布？",
            ...
            multipleChoice: [
                {
                    question: "以下哪些是常见的数据质量问题？（多选）",
                    options: ["缺失值", "异常值", "重复数据", "数据类型错误"],
                    answer: [0, 1, 2, 3]
                },
                {
            ...
            codeQuestion: {
                question: "编写代码：创建一个包含缺失值的DataFrame，统计各列缺失值数量，并用中位数填充数值列的缺失值",
...
`
    },
    {
        ...
        theory: `
<h3>一、数据可视化概述</h3>
<p>数据可视化是将数据转化为图形或图表的过程，帮助人们理解数据中的模式、趋势和关系。</p>

<h4>1.1 可视化的重要性</h4>
<ul>
    <li><b>发现模式</b>：可视化能帮助发现数据中的隐藏模式</li>
    <li><b>沟通交流</b>：图表比表格更易于理解和传播</li>
    <li><b>决策支持</b>：帮助决策者快速把握关键信息</li>
    <li><b>讲故事</b>：通过可视化讲述数据背后的故事</li>
</ul>

<h4>1.2 可视化设计原则</h4>
<ul>
    <li><b>清晰性</b>：避免不必要的装饰，保持简洁</li>
    <li><b>准确性</b>：数据展示必须准确无误</li>
...
<ul>
    <li><b>用途</b>：展示趋势变化、时间序列数据</li>
    <li><b>特点</b>：适合展示连续数据的变化趋势</li>
    <li><b>示例场景</b>：股票价格走势、销售趋势、温度变化</li>
</ul>

<h4>2.2 柱状图 (Bar Chart)</h4>
<ul>
    <li><b>用途</b>：比较不同类别的数据</li>
    <li><b>特点</b>：适合离散数据的比较</li>
    <li><b>示例场景</b>：各部门销售额对比、不同产品销量比较</li>
...
<ul>
    ...
    <li><b>示例场景</b>：身高与体重的关系、广告投入与销售额</li>
    <li><b>颜色编码</b>：可使用颜色表示第三个变量</li>
</ul>

<h4>2.4 直方图 (Histogram)</h4>
<ul>
    <li><b>用途</b>：展示数据的分布情况</li>
    <li><b>特点</b>：将数据分组，显示每组的频数</li>
    <li><b>示例场景</b>：学生成绩分布、收入分布</li>
    <li><b>注意</b>：与柱状图的区别在于直方图展示连续数据</li>
</ul>

<h4>2.5 饼图 (Pie Chart)</h4>
<ul>
    <li><b>用途</b>：展示各部分占总体的比例</li>
    <li><b>特点</b>：适合展示百分比数据</li>
...
<ul>
    <li><b>用途</b>：展示数据的分布和异常值</li>
    <li><b>特点</b>：显示五数概括（最小值、Q1、中位数、Q3、最大值）</li>
    <li><b>示例场景</b>：比较不同组数据的分布、识别异常值</li>
</ul>
...
<h3>五、实战建议</h3>
<ul>
    <li><b>选择合适的图表类型</b>：根据数据类型和分析目的选择</li>
    ...
    <li><b>测试不同的配色方案</b>：确保图表在不同场景下都可读</li>
        ...
        exam: {
            singleChoice: [
                {
                    question: "展示时间序列数据的趋势变化，最合适的图表类型是？",
                    options: ["柱状图", "折线图", "饼图", "直方图"],
                    answer: 1
                },
                {
                    question: "以下哪种图表适合展示数据的分布情况？",
...
`
    },
    {
        ...
        theory: `
<h3>一、统计学概述</h3>
<p>统计学是研究数据收集、整理、分析和解释的科学，是数据分析的核心基础。</p>

<h4>1.1 统计学的重要性</h4>
<ul>
    <li><b>数据理解</b>：帮助理解数据的特征和规律</li>
    <li><b>决策支持</b>：为决策提供量化依据</li>
    <li><b>预测未来</b>：基于历史数据预测未来趋势</li>
    <li><b>假设检验</b>：验证假设是否成立</li>
</ul>

<h4>1.2 统计学分类</h4>
<ul>
    <li><b>描述性统计</b>：总结和描述数据的基本特征</li>
...
<h5>均值 (Mean)</h5>
<ul>
    <li><b>定义</b>：所有数据值的总和除以数据个数</li>
    <li><b>公式</b>：μ = (x₁ + x₂ + ... + xₙ) / n</li>
    <li><b>优点</b>：利用所有数据信息</li>
    <li><b>缺点</b>：受极端值影响较大</li>
    <li><b>适用场景</b>：数据分布对称，无极端值</li>
</ul>

<h5>中位数 (Median)</h5>
<ul>
    <li><b>定义</b>：将数据排序后位于中间位置的值</li>
    <li><b>计算</b>：n为奇数时取中间值，n为偶数时取中间两个值的平均</li>
    <li><b>优点</b>：不受极端值影响</li>
    <li><b>适用场景</b>：数据存在极端值或偏态分布</li>
</ul>
...
<ul>
    ...
    <li><b>缺点</b>：只考虑两个极端值，忽略中间数据</li>
</ul>

<h5>方差 (Variance)</h5>
<ul>
    <li><b>定义</b>：各数据与均值差的平方的平均值</li>
    <li><b>公式</b>：σ² = Σ(xᵢ - μ)² / n</li>
    <li><b>特点</b>：单位是数据单位的平方</li>
</ul>
...
<ul>
    <li><b>定义</b>：方差的平方根</li>
    <li><b>公式</b>：σ = √(σ²)</li>
    <li><b>特点</b>：单位与数据单位相同，更易理解</li>
    <li><b>解释</b>：约68%的数据在均值±1σ范围内</li>
</ul>
...
<h5>峰度 (Kurtosis)</h5>
<ul>
    <li><b>定义</b>：衡量数据分布的峰态</li>
    <li><b>尖峰</b>：峰度 > 0，数据集中在均值附近</li>
    <li><b>平峰</b>：峰度 < 0，数据分布较为分散</li>
    <li><b>正态分布</b>：峰度 = 0</li>
</ul>
...
<ul>
    ...
    <li><b>P值</b>：在原假设成立时，观察到当前数据或更极端数据的概率</li>
...
<ul>
    ...
    <li><code>df.corr()</code> - 相关矩阵</li>
        ...
        exam: {
            singleChoice: [
                {
                    question: "描述数据集中趋势的指标不包括？",
                    options: ["均值", "中位数", "标准差", "众数"],
                    answer: 2
                },
                {
                    question: "当数据存在极端值时，最好使用哪个指标表示集中趋势？",
                    options: ["均值", "中位数", "众数", "标准差"],
                    answer: 1
                },
                {
                    question: "正态分布中，约多少数据在均值±1标准差范围内？",
...
`
    },
    {
        ...
        theory: `
<h3>一、Pandas概述</h3>
<p>Pandas是Python数据分析的核心库，提供高性能、易用的数据结构和数据分析工具。</p>

<h4>1.1 Pandas的特点</h4>
<ul>
    <li><b>强大的数据结构</b>：DataFrame和Series</li>
    <li><b>数据处理能力</b>：清洗、转换、聚合</li>
    <li><b>数据读取</b>：支持多种格式（CSV、Excel、SQL等）</li>
...
<ul>
    ...
    <li><code>df.shape</code> - 数据形状（行数,列数）</li>
    <li><code>df.info()</code> - 数据类型和非空值信息</li>
    <li><code>df.dtypes</code> - 各列数据类型</li>
...
<ul>
    ...
    <li>使用query()方法进行复杂筛选</li>
        ...
        exam: {
            ...
            codeQuestion: {
                question: "编写代码：创建一个销售DataFrame，包含产品、区域、销量、单价列，计算销售额，按产品分组统计总销量和总销售额，并按销售额降序排序",
                initialCode: "# 请在此处编写代码\nimport pandas as pd\nimport numpy as np\n\n# 创建销售DataFrame\n\n\n# 计算销售额\n\n\n# 按产品分组统计\n\n\n# 按销售额降序排序",
...
<h4>2.3 子图共享轴</h4>
<ul>
    <li><code>plt.subplots(sharex=True)</code> - 共享X轴</li>
    <li><code>plt.subplots(sharey=True)</code> - 共享Y轴</li>
    <li><code>plt.subplots(sharex='col')</code> - 按列共享X轴</li>
</ul>
...
<ul>
    ...
    <li><code>plt.axhspan(ymin, ymax, alpha=0.2)</code> - 水平阴影区域</li>
    <li><code>plt.axvspan(xmin, xmax, alpha=0.2)</code> - 垂直阴影区域</li>
</ul>
...
<h4>6.1 设置范围</h4>
<ul>
    <li><code>plt.xlim(min, max)</code> - 设置X轴范围</li>
    <li><code>plt.ylim(min, max)</code> - 设置Y轴范围</li>
</ul>
...
<h4>6.3 双Y轴</h4>
<ul>
    <li><code>ax2 = ax1.twinx()</code> - 创建双Y轴</li>
    <li><b>应用场景</b>：同时展示两个不同尺度的数据</li>
</ul>
...
`
    },
    {
        ...
        theory: `
<h3>一、假设检验概述</h3>
<p>假设检验是推断性统计的核心方法，用于判断样本数据是否支持对总体的某种假设。</p>
...
<ul>
    ...
    <li><b>前提</b>：两组数据均近似正态分布，方差相等或不等</li>
        ...
        exam: {
            ...
            multipleChoice: [
                ...
                },
                {
                    ...
                    options: ["数据不满足正态分布", "样本量较小", "有序分类数据", "连续型数据"],
                    answer: [0, 1, 2]
                }
            ],
            trueFalse: [
...
`
    },
    {
        ...
        title: "时间序列分析",
        level: "进阶",
        description: "学习时间序列数据处理和预测",
        theory: `
<h3>一、时间序列概述</h3>
<p>时间序列是按时间顺序排列的数据序列，广泛应用于金融、气象、销售等领域。</p>
...
# 原始数据和平滑
axes[0].plot(df.index, df['value'], alpha=0.5, label='原始数据')
...
`
    },
    {
        ...
        theory: `
<h3>一、关联规则概述</h3>
<p>关联规则挖掘发现数据中项之间的有趣关联，广泛应用于零售分析、用户行为研究等领域。</p>
...
`
    },
    {
        ...
        theory: `
<h3>一、聚类分析概述</h3>
<p>聚类是无监督学习方法，将数据集中的样本划分为若干个簇，使同簇内样本相似度高，不同簇间相似度低。</p>
        ...
        exam: {
            singleChoice: [
                ...
                },
                {
                    ...
                    options: ["数据量大小", "初始质心选择和异常值", "数据维度", "计算速度"],
                    answer: 1
                }
            ],
            multipleChoice: [
